...
- "050 פלאפון קונצאי שלום חיים" → {"action": "create_invoice", "product": "050 פלאפון", "contact": "קונצאי", "account": "שלום חיים"}
- "050 מיקמיק אילן" → {"action": "create_invoice", "product": "050 מיקמיק", "contact": "", "account": "אילן"}
...
- "בלוטוס קשת דורון" → {"action": "create_invoice", "product": "בלוטוס קשת", "contact": "", "account": "דורון"}
- "מכשיר גלקסי רני ישע" → {"action": "create_invoice", "product": "מכשיר גלקסי", "contact": "רני", "account": "ישע"}
- "אוזניות JBL אילן" → {"action": "create_invoice", "product": "אוזניות JBL", "contact": "", "account": "אילן"}
- "מזגן נייד דורון" → {"action": "create_invoice", "product": "מזגן נייד", "contact": "", "account": "דורון"}
- "סוללה 48 אילן" → {"action": "create_invoice", "product": "סוללה 48", "contact": "", "account": "אילן"}
